DocManager.module("BudgetApp.Edit", function(Edit, DocManager, Backbone, Marionette, $, _){
  ...
  Edit.MainHeader = DocManager.BudgetApp.Common.Views.Form.extend({
  ...
  Edit.Search = DocManager.BudgetApp.Common.Views.SearchPanel.extend({
    initialize: function(options){
  ...
  Edit.Document = DocManager.BudgetApp.Common.Views.Form.extend({
  ...
  Edit.SolicitudDetail = DocManager.BudgetApp.Common.Views.Form.extend({
  ...
  // Cabecera del itam
  Edit.ItemHeader = DocManager.BudgetApp.Common.Views.Form.extend({
  ...
  Edit.PTecnicoListItem = DocManager.BudgetApp.Common.Views.Form.extend({
    templates: {
