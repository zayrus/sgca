MediaManager.module("Entities", function(Entities, MediaManager, Backbone, Marionette, $, _){
  ...
  MediaManager.reqres.setHandler("person:entities", function(){
    return API.getEntities();
  });

  MediaManager.reqres.setHandler("person:entity", function(id){
    return API.getEntity(id);
  });

  MediaManager.reqres.setHandler("person:filtered:entities", function(criteria, cb){
