  ...
  Show.DocumentItemsLayout = Marionette.Layout.extend({
    ...
    onShow:function(){
      ...
      items = new Show.DocumentSubitems({
          collection: new StudioManager.Entities.DocumSubItemsCollection(this.model.get('items'),{
...
/*      
      if(this.model.get('tipoitem')==='ptecnico'){
        items = new Show.DocumentSubitems({
          collection: new StudioManager.Entities.PTecnicoItems(this.model.get('items')),
          tpl: 'ptecnico'
        });
      } else if(this.model.get('tipoitem')==='nrecepcion' || this.model.get('tipoitem')==='nentrega'){
        items = new Show.DocumentSubitems({
          collection: new StudioManager.Entities.MovimREItems(this.model.get('items')),
          tpl: 'nrecepcion'
        });
      }
