StudioManager.module("Entities", function(Entities, StudioManager, Backbone, Marionette, $, _){
  ...
  StudioManager.reqres.setHandler("person:entities", function(){
    return API.getEntities();
  });

  StudioManager.reqres.setHandler("person:entity", function(id){
    return API.getEntity(id);
  });

  StudioManager.reqres.setHandler("person:filtered:entities", function(criteria, cb){
