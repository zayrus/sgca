...
*/
  ...
  var fetchProductDuration = function(col, cb){
    var products = new StudioManager.Entities.ProductCollection();
  ...
  StudioManager.reqres.setHandler("document:entities", function(){
    return API.getEntities();
  });

  StudioManager.reqres.setHandler("document:filtered:entities", function(criteria, cb){
    return API.getFilteredCol(criteria,cb);
  });

  StudioManager.reqres.setHandler("document:query:entities", function(query, cb){
    return API.getFilteredByQueryCol(query,cb);
  });

  StudioManager.reqres.setHandler("document:entity", function(id){
    return API.getEntity(id);
  });

  StudioManager.reqres.setHandler("document:fetchprev", function(model, cb){
    return API.fetchNextPrev('fetchprev',model, cb);
  });

  StudioManager.reqres.setHandler("document:fetchnext", function(model, cb){
